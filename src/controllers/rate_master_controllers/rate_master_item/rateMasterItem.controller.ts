...
import * as itemService from "./rateMasterItem.service.js"; // TODO confirm path
...
export const createItem = async (
  ...
  try {
    ...
    res.status(201).json({ ok: true, data: result, message: "Rate master item created successfully" });
  } catch (error) {
    next(error);
  }
};

// Supports optional ?categoryId= and ?confidence= filters, matching the
// Rate Card demo's filter bar (category pills + confidence badges).
export const getAllItems = async (
  ...
  try {
    ...
    res
      .status(200)
      .json({ ok: true, data: result, message: "Rate master items fetched successfully" });
  } catch (error) {
    next(error);
  }
};
...
export const getItemById = async (
  ...
  try {
    ...
    res
      .status(200)
      .json({ ok: true, data: result, message: "Rate master item fetched successfully" });
  } catch (error) {
    next(error);
  }
};
...
export const updateItem = async (
  ...
  try {
    ...
    res
      .status(200)
      .json({ ok: true, data: result, message: "Rate master item updated successfully" });
  } catch (error) {
    next(error);
  }
};
...
export const softDeleteItem = async (
  ...
  try {
    ...
    res
      .status(200)
      .json({ ok: true, data: result, message: "Rate master item deactivated successfully" });
  } catch (error) {
    next(error);
  }
};
...
export const recoverItem = async (
  ...
  try {
    ...
    res
      .status(200)
      .json({ ok: true, data: result, message: "Rate master item recovered successfully" });
  } catch (error) {
    next(error);
  }
};
...
export const hardDeleteItem = async (
  ...
  try {
    ...
    res.status(200).json({ ok: true, data: null, message: "Rate master item permanently deleted" });
  } catch (error) {
    next(error);
  }
};
...
export const getInactiveItems = async (
  ...
  try {
    ...
    res
      .status(200)
      .json({ ok: true, data: result, message: "Inactive rate master items fetched successfully" });
  } catch (error) {
    next(error);
  }
};